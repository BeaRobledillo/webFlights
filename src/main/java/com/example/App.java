...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Ticket t1 = new Ticket(null, "A1", 58.8, false, null, f1, psg1);
        Ticket t2 = new Ticket(null, "A2", 58.8, false, null, f2, psg1);
        Ticket t3 = new Ticket(null, "A3", 58.8, false, null, f3, psg1);
        Ticket t4 = new Ticket(null, "B1", 58.8, false, null, f1, psg2);
        Ticket t5 = new Ticket(null, "C1", 150.0, false, null, f1, null);
        Ticket t6 = new Ticket(null, "D1", 150.0, false, null, f2, null);
        Ticket t7 = new Ticket(null, "E1", 150.0, false, null, f3, null);
        Ticket t8 = new Ticket(null, "F1", 150.0, false, null, f1, null);
